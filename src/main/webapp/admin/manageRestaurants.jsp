...
<body>
	<div class = "addRestuarant">
		<%Restaurant restaurant = (Restaurant)request.getAttribute("restaurant"); %>
		<h2><%=(restaurant == null) ? "Add new Restaurant" : "Update Retaurant"%></h2>
		<form action="<%= request.getContextPath() %>/callRestaurantManager_CRUD" method="post" enctype="multipart/form-data">
			<div><label>Restaurant Name</label><input type="text" name="restaurantName"  value="<%=restaurant != null ? restaurant.getName(): "" %>" required></div>
			<div><label>Cuisine Type</label><input type="text" name="cuisineType" value="<%=restaurant != null ? restaurant.getCuisineType(): "" %>" required></div>
			<div><label>Delivery Time</label><input type="number" name="deliveryTime" value="<%=restaurant != null ? restaurant.getDeliveryTime(): "" %>" required></div>
			<div><label>Address</label>
			<textarea name="address" rows="3" required ><%=restaurant != null ? restaurant.getAddress(): "" %></textarea>
			</div>
			<div><label>Admin User Id</label><input type="number" name="adminUserId" value="<%=restaurant != null ? restaurant.getAdminUserId(): "" %>" required></div>
			<div><label>Rating</label><input type="number" min="0" max="5" step="0.1"name="rating" value="<%=restaurant != null ? restaurant.getRating(): "" %>" required></div>
			
			<div><label>isActive</label>
			<select name="isActive" required>
				<option value="1"
				<%=restaurant != null && restaurant.getIsActive() == 1 ? "selected": "" %>>
				Active</option>
				<option value="0"
				<%=restaurant != null && restaurant.getIsActive() == 0 ? "selected": "" %>>
				Inactive</option>
			</select>
			</div>
			...
			<%if(restaurant != null){ %>
				<img alt="could not load image" src="<%=request.getContextPath() %>/assets/<%=restaurant.getImages()%>" width="150" height="100">
				<br><br>
			...
			<input type="submit" value=<%=restaurant == null ? "Add Restaurant": "Update Restaurant" %>>
		</form> 
	</div>
...
<div class="card">
    ...
    <a href="callManageMenuServlet?restaurantId=<%= r.getRestaurantId() %>" class="btn">View Restaurant</a>
      ...
      <div class="restaurant-card scroll-3d delay-<%= d %>">
        ...
        <div class="card-body">
          ...
          <div class="card-actions">
            <a href="callManageMenuServlet?restaurantId=<%= r.getRestaurantId() %>" class="btn view">View Menu</a>
            <form action="<%= request.getContextPath() %>/callRestaurantManager_CRUD" method="post">
              <input type="hidden" name="action" value="edit">
              <input type="hidden" name="restaurantId" value="<%= r.getRestaurantId() %>">
              <input type="submit" value="Edit" class="btn">
