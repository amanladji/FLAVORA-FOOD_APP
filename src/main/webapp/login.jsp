...
<section class="hero">
  <div class="hero-left">
    ...
    <p class="hero-tagline">
      Sign in to continue your flavour journey â your favourite kitchens are waiting.
    </p>
  ...
  <div class="hero-right">
    <form action="callLoginServlet" method="post" class="login-card" id="loginCard" novalidate>
      <h2>Login</h2>
      <p class="card-sub"><em>welcome back</em></p>
...
<footer class="footer">
  ...
  <div class="footer-inner">
    ...
    <div style="text-align:right;">
      <p class="footer-copy" style="margin-bottom:16px;">Â© 2026 Flavora. All rights reserved.</p>
      <a href="#" class="footer-top-link">Back to top â</a>
    </div>
  </div>
</footer>
